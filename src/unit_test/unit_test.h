...
private:
    inline Ishlang::Value arrval(const auto &... vs) { return Ishlang::Value(Ishlang::Sequence({vs...})); }
    inline Ishlang::Value arrval() { return Ishlang::Value(Ishlang::Sequence()); }
